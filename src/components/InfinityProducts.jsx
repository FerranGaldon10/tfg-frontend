...
function InfinityProducts() {
    ...
    const productToImport = products.filter((product) => product.special === "infinity");
  ...
  return (
    <div className="pt-20 pb-20" >
        ...
        <h1 className=" pb-10 md:pt-15 text-center text-sm font-semibold text-black">{t("infinity.title")}</h1>

        <div className="grid grid-cols-4 md:grid-cols-1 md:grid-flow-row md:grid-rows-4 lg:grid-cols-2 w-screen justify-items-center justify-content-center ">
        ...
        <div className="flex mt-10 justify-center items-center">
            <button className="text-white bg-black px-8 py-3 text-sm font-medium hover:bg-gray-800 transition duration-300"><a href="/pages/App2.html">{t("infinity.button")}</a></button>
        </div>
