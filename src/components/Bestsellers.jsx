...
function Bestsellers() {
    ...
    const productToImport = products.filter((product) => product.special === "bestseller");
  ...
  return (
    <div className="pt-20 pb-20" >
        <h1 className=" pb-10 md:pt-15 text-center text-sm font-semibold text-black">{t("bestsellers.title")}</h1>
        ...
        <div className="flex mt-10 justify-center items-center">
            <button className="text-white bg-black px-8 py-3 text-sm font-medium hover:bg-gray-800 transition duration-300"><a href="/pages/App2.html">{t("bestsellers.button")}</a></button>
        </div>
